...
import { ScavengerHuntSubmission } from 'app/(admin)/scavenger/submissions/actions';
...
const ScavengerHuntSubmissionsComponent: FC<ScavengerHuntSubmissionsComponentProps> = ({ submissions }) => {
  ...
  const renderSubmission = useCallback((submission: ScavengerHuntSubmission, index: number): ReactNode => {
